let customers = [
  ...
  let newEmailAddressesArray = []
      const emailAddresses = customers.forEach(customer => {
        customerEmails = customer.contacts.email
        customerEmails.forEach(email => {
            newEmailAddressesArray.push(email)
        })
      })
  console.log(newEmailAddressesArray);